...
(seq 1 22; echo X; echo Y) | while read i; do echo $i; sbatch -p 386mem -x octopus07,octopus10 -c 48 --wrap "hostname; cd /scratch; cp /lizardfs/guarracino/sorting-paper/graphs/chr${i}.hprc-v1.0-pggb.og chr${i}.hprc-v1.0-pggb.og; \time -v $ODGI layout -i chr${i}.hprc-v1.0-pggb.og -o chr${i}.hprc-v1.0-pggb.lay -T chr${i}.hprc-v1.0-pggb.tsv -t 48 --temp-dir /scratch/ -P; rm chr${i}.hprc-v1.0-pggb.og; mv chr${i}.hprc-v1.0-pggb.* /lizardfs/guarracino/sorting-paper/layouts/"; done

# Compute the layout (both LAY and TSV formats) with harder parameters (-x 300 -G 30 -I 50000 -l 5000)
cd /lizardfs/guarracino/sorting-paper/layouts
(seq 1 22; echo X; echo Y) | while read i; do echo $i; sbatch -p 386mem -x octopus07,octopus10 -c 48 --wrap "hostname; cd /scratch; cp /lizardfs/guarracino/sorting-paper/graphs/chr${i}.hprc-v1.0-pggb.og chr${i}.hprc-v1.0-pggb.og; \time -v $ODGI layout -i chr${i}.hprc-v1.0-pggb.og -o chr${i}.hprc-v1.0-pggb.x300.G30.I50k.l50k.lay -T chr${i}.hprc-v1.0-pggb.x300.G30.I50k.l50k.tsv -t 48 --temp-dir /scratch/ -x 300 -G 30 -I 50000 -l 5000 -P; rm chr${i}.hprc-v1.0-pggb.og; mv chr${i}.hprc-v1.0-pggb.x300.G30.I50k.l50k.* /lizardfs/guarracino/sorting-paper/layouts/"; done
