...
\begin{document}
    ...
    \abstract{
        \textbf{Motivation:}
        The increasing availability of high-quality genomes demands models for studying genomic variability within entire populations.
        ...
        Our method, driven by the HOGWILD! strategy, arranges the nodes of a pangenome graph using the nucleotide sequences of the genomes represented in the graph.
        We demonstrate that our implementation efficiently computes the latent structure of gigabase-scale pangenome graphs, revealing their biological features. \\
        \textbf{Availability:}
        The PG-SGD algorithm is integrated in \text{ODGI} which is released as free software under the MIT open source license.
    ...
    %\FIXME{WE ONLY WANT TO TAKE ABOUT LAYOUTS AND PRODUCING LAYOUTS, NOT ABOUT GRAPH SORTING.
    %PG-SGD PRODUCES 1D and 2D LAYOUTS.
    %IN 1D WE SORT A GRAPH BY PROJECTING THE ACTUAL 1D LAYOUT INTO A NODE ORDER!}
