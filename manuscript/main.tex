...
\begin{document}
	...
	Our HOWGWILD! method uses the path position information of the genomes represented in the pangenome graph to move pairs of nodes in parallel.
	...
	%@Andrea: I don't think we need a figure which describes nodes, edges, paths. And how a variation graph looks like. Because, there already exists tons of them and we would just make another such figure.
	...
	This paper describes a new pangenome graph layout algorithm which uses path-guided stochastic gradient descent %\citep{Zheng2019}
	...
	%efficiency, scalability, readability, and the ability to reveal significant biological patterns. \FIXME{MOVE THIS SOMEWHERE ELSE?}
