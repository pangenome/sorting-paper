...
\begin{document}
	...
	PG-SGD uses the genomic paths in the pangenome graph as an embedded positional system to sample genomic distances between pairs of nodes, avoiding the quadratic cost seen in previous versions of graph drawing by Stochastic Gradient Descent (SGD).
