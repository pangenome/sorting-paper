...
\begin{document}
	...
	In the ODGI toolkit \citep{Guarracino2022}, we provide implementations for 1-dimensional (1D) and 2-dimensional (2D) layouts. The respective algorithms were already successfully applied to build and visualize large scale pangenome graphs of the Human Pangenome Resource Consortium (HPRC)~\citep{Liao2023, Guarracino2023}.
