...
\begin{document}
	...
	Our implementation is multithreaded and follows the HOGWILD! strategy, that is threads perform layout updates without any locking.
	...
	With respect to the HOGWILD! SGD algorithm \citep{Recht2011} which writes the layout updates to a shared non-atomic integer vector, PG-SGD stores node coordinates in an atomic integer vector.
