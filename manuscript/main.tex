...
\abstract{
\textbf{Motivation:}
The availability of many high-quality genomes has led to the need for models that allow the study of genomic variability within entire populations.
...
Our approach arranges the nodes of a pangenome graph by leveraging the HOGWILD! strategy and it is guided by the path position information of the genomes represented in the graph.
