...
\begin{document}
    ...
    We additionally support fixing a set of node coordinates, such as those in a reference genome, in their order and position, which allows us to build 1D reference-focused views of complex pangenomes. An exapmle visualization is given in Figure~\ref{fig:1d_fig4}.
    \FIXME{Is this only for 1D? It would be \textit{amazing} if it were possible to do in 2D, and it should be easy. -EG} \\
    \FIXME{I am afraid this only works for 1D. Or what do you make of \url{https://github.com/pangenome/odgi/pull/491}? -SH}
