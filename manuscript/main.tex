...
\begin{document}
	...
	One popular approach is force-directed graph drawing \citep{cheong_force-directed_2022} which produces aesthetic layouts. %by ....
	...
	Also, existing graph layout approaches ignore the biological information inherent in pangenome graphs.
