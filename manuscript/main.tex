...
\begin{document}
	...
	However, the key difference here is that this approach is path-guided using a “biological force”, but paths represent biological sequences in pangenome graphs, so it is as if PG-SDG considers a “biological force” for placing the graph nodes.
